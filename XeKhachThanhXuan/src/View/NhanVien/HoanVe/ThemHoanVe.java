...
public class ThemHoanVe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        trolai1 = new javax.swing.JButton();
                    ...
                    .addGroup(VeLayout.createSequentialGroup()
                        ...
                        .addGroup(VeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(VeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(thoigiankhoihanh, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                                ...
                                .addComponent(biensoxe, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE))
                            .addComponent(vitrighe, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(loaixe, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(VeLayout.createSequentialGroup()
                    ...
                    .addGroup(VeLayout.createSequentialGroup()
                        ...
                        .addGroup(VeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(VeLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel53))
                            .addComponent(vitrighe, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(VeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel48)
                            .addComponent(loaixe))
        ...
        trolai1.setFont(new java.awt.Font("Lora SemiBold", 0, 14)); // NOI18N
        trolai1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/QuanLy/Icon/QuanLyTuyenXe/icons8_return_30px.png"))); // NOI18N
        trolai1.setText("Trở lại");
        trolai1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                trolai1ActionPerformed(evt);
            }
        });
        ...
        IDDatve.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IDDatveKeyPressed(evt);
            }
        });
        ...
        TimKiem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/QuanLy/Icon/QuanLyTuyenXe/icons8_search_30px_3.png"))); // NOI18N
                ...
                .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(BLayout.createSequentialGroup()
                        ...
                        .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(BLayout.createSequentialGroup()
                                .addComponent(IDDve, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(IDDatve, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(BLayout.createSequentialGroup()
                                .addGap(8, 8, 8)
                                .addComponent(TimKiem, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(95, 95, 95)
                                .addComponent(trolai1, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BLayout.createSequentialGroup()
                    .addContainerGap(57, Short.MAX_VALUE)
                    .addComponent(Ve, javax.swing.GroupLayout.PREFERRED_SIZE, 543, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BLayout.createSequentialGroup()
                ...
                .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(BLayout.createSequentialGroup()
                        ...
                        .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(IDDve, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(BLayout.createSequentialGroup()
                        ...
                        .addGap(15, 15, 15))
                    .addGroup(BLayout.createSequentialGroup()
                        .addComponent(trolai1, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            .addGroup(BLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(BLayout.createSequentialGroup()
                    .addGap(44, 44, 44)
                    .addComponent(Ve, javax.swing.GroupLayout.PREFERRED_SIZE, 300, Short.MAX_VALUE)
                    .addGap(156, 156, 156)))
        );
    ...
    private void ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThemActionPerformed
        ...
        if (flag == true) {
            try {
                Connection conn = CheckOracleConnection.getMyConnection();
                String sql = "SELECT TINHTRANG FROM DATVE WHERE ID_DATVE='" + iddatve + "'";
                ...
                if (tinhtrang.equals("Chưa thanh toán")) {
                    JOptionPane.showMessageDialog(this, "Vé chưa thanh toán");
                    flag = false;
                } else if (tinhtrang.equals("Đã hoàn")) {
        ...
        if (flag == true) {
            try {
                ...
                if (A == 0) {
                    JOptionPane.showMessageDialog(this, "Vé đã quá hạn để hoàn");

                } else if (A > 0) {
                    try {
                        B = a.Them_HoanVe(iddatve, idnhanvien);
                        if (B == 0) {
    ...
    private void Tim_Kiem() throws HeadlessException {
        // TODO add your handling code here:
        String maDatVe = null;
        String hoTen = null;
        ...
        if (flag == true) {
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Mã đặt vé không tồn tại");
                    flag = false;
                }
        ...
        try {
            ...
            while (rs.next()) {
                ...
                phihoanve = a.PhiHoanVe(iddatve);
                tienhoanve = a.TienHoanVe(iddatve);
    ...
    private void trolai1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_trolai1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_trolai1ActionPerformed

    private void IDDatveKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IDDatveKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Tim_Kiem();
        }
    }//GEN-LAST:event_IDDatveKeyPressed
    ...
    private javax.swing.JButton trolai1;
