 ...
 * @author DUNG
 */
public class CapNhat_GiaVe extends javax.swing.JFrame {

    /**
     * Creates new form EditGiaVe
     */
    public CapNhat_GiaVe() {
        initComponents();
        ComboboxIDloai();
        ComboboxIDtuyen();
        fillTable();
    ...
    private void initComponents() {
        ...
        Sua.setFont(new java.awt.Font("Lora", 1, 14)); // NOI18N
        Sua.setText("Sửa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhat_GiaVe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapNhat_GiaVe().setVisible(true);
            }
        });
    }
    ...
    private void showDetail() {
        ...
        IDloaixe.setSelectedItem(danhsachgiave.getModel().getValueAt(danhsachgiave.getSelectedRow(), 0) + "");
        IDtuyenxe.setSelectedItem(danhsachgiave.getModel().getValueAt(danhsachgiave.getSelectedRow(), 1) + "");
        GiaVe.setText(danhsachgiave.getModel().getValueAt(danhsachgiave.getSelectedRow(), 2) + "");
